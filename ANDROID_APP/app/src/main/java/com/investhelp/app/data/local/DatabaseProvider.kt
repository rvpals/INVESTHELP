...
class DatabaseProvider @Inject constructor(
    ...
    companion object {
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("""
                    CREATE TABLE IF NOT EXISTS sharpe_ratio_cache (
                        ...
                        annualizedVolatility REAL NOT NULL,
                        alignedTradingDays INTEGER NOT NULL,
                        meanDailyReturn REAL NOT NULL,
                        dailyRiskFreeRateUsed REAL NOT NULL,
                        calculationDate TEXT NOT NULL,
                        tickerDetailsJson TEXT NOT NULL,
                        portfolioReturnSeriesJson TEXT NOT NULL,
                        skippedTickersJson TEXT NOT NULL,
                        skipReasonsJson TEXT NOT NULL,
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("""
                    CREATE TABLE IF NOT EXISTS correlation_cache (
                        ...
                        marketCorrelationJson TEXT NOT NULL,
                        failedTickersJson TEXT NOT NULL,
                        calculatedAt INTEGER NOT NULL
                    )
                """.trimIndent())
            }
            ...
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("""
                    CREATE TABLE IF NOT EXISTS volatility_cache (
                        ...
                        annualizedVolPct REAL NOT NULL,
                        dailyStdDevPct REAL NOT NULL,
                        volatilityLabel TEXT NOT NULL,
                        low52w REAL NOT NULL,
                        high52w REAL NOT NULL,
                        rangePositionPct REAL NOT NULL,
        ...
        val MIGRATION_29_30 = object : Migration(29, 30) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE investment_positions ADD COLUMN dividendRate REAL NOT NULL DEFAULT 0")
            }
        }
